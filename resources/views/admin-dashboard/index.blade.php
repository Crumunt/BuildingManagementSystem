         ...
         <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
               ...
               <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                  ...
                  <span
                     class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Building Management System</span>
               </a>
            </div>
      ...
      <div class="p-4 rounded-lg mt-14">
         ...
         <div class="grid mb-4">
            <div class="border-2 border-dashed border-slate-500 p-2">
               ...
               <div class="h-96 border-2 border-dashed border-slate-500 mt-5 bg-gray-300 rounded-lg flex items-center justify-center">
